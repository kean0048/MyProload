...
export PKG_E2FSPROGS=https://src.fedoraproject.org/repo/pkgs/e2fsprogs/e2fsprogs-1.46.5.tar.xz
...
export PKG_FILE=https://ftp.icm.edu.pl/packages/file/file-5.42.tar.gz
...
export PKG_FREETYPE=https://downloads.sourceforge.net/freetype/freetype-2.11.1.tar.xz
export PKG_FREETYPEDOC=https://downloads.sourceforge.net/freetype/freetype-doc-2.11.1.tar.xz
...
export PKG_LESS=https://ftp.gnu.org/gnu/less/less-590.tar.gz
...
export PKG_LINUX=https://www.kernel.org/pub/linux/kernel/v6.x/linux-6.9.4.tar.xz
...
export PKG_XZ=https://udomain.dl.sourceforge.net/project/lzmautils/xz-5.2.6.tar.xz
export PKG_ZLIB=https://github.com/madler/zlib/releases/download/v1.2.13/zlib-1.2.13.tar.xz
